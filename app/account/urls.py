...
from .views import RegisterView, LoginView, AccountView, AccountRetrieveUpdateView, ChangePasswordViews, \
...
urlpatterns = [
    ...
    path('set-password/<int:pk>/', ChangePasswordViews.as_view())
]
